...
var defaultConfig = types.PluginConfig{
	...
	// As AMM price can move very quickly, thus we prefer price sampling without any delay to reduce the risk of slashing.
	DataUpdateInterval: common.DefaultAMMDataUpdateInterval, // 1s, rate limit is not required as AMM data are sourced from operator's own node.
