...
// MockPluginWrapper is a mock of PluginWrapper interface.
type MockPluginWrapper struct {
	ctrl     *gomock.Controller
	recorder *MockPluginWrapperMockRecorder
}

// MockPluginWrapperMockRecorder is the mock recorder for MockPluginWrapper.
type MockPluginWrapperMockRecorder struct {
	mock *MockPluginWrapper
}

// NewMockPluginWrapper creates a new mock instance.
func NewMockPluginWrapper(ctrl *gomock.Controller) *MockPluginWrapper {
	mock := &MockPluginWrapper{ctrl: ctrl}
	mock.recorder = &MockPluginWrapperMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPluginWrapper) EXPECT() *MockPluginWrapperMockRecorder {
	return m.recorder
}

// Close mocks base method.
func (m *MockPluginWrapper) Close() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Close")
}

// Close indicates an expected call of Close.
func (mr *MockPluginWrapperMockRecorder) Close() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockPluginWrapper)(nil).Close))
}

// FetchPrices mocks base method.
func (m *MockPluginWrapper) FetchPrices(symbols []string) error {
	m.ctrl.T.Helper()
...
func (mr *MockPluginWrapperMockRecorder) FetchPrices(symbols interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FetchPrices", reflect.TypeOf((*MockPluginWrapper)(nil).FetchPrices), symbols)
}

// Name mocks base method.
func (m *MockPluginWrapper) Name() string {
	m.ctrl.T.Helper()
...
func (mr *MockPluginWrapperMockRecorder) Name() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Name", reflect.TypeOf((*MockPluginWrapper)(nil).Name))
}

// StartTime mocks base method.
func (m *MockPluginWrapper) StartTime() time.Time {
	m.ctrl.T.Helper()
...
func (mr *MockPluginWrapperMockRecorder) StartTime() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StartTime", reflect.TypeOf((*MockPluginWrapper)(nil).StartTime))
}

// Version mocks base method.
func (m *MockPluginWrapper) Version() string {
	m.ctrl.T.Helper()
...
func (mr *MockPluginWrapperMockRecorder) Version() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Version", reflect.TypeOf((*MockPluginWrapper)(nil).Version))
}
