...
func (os *OracleServer) aggMulSrcPrice(symbol string, ts int64, sourcedPrices []types.Price) (*types.Price, error) {
	...
	if noVolumes {
		...
		// return with the highest confidence and CWAP price for Aggregated strategy or for Max strategy when there is no best confidence price addressed.
	...
	// return with the highest confidence and VWAP price for Aggregated strategy or for Max strategy when there is no best confidence price addressed.
